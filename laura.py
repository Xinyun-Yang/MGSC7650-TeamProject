...
# file_path = '/content/drive/MyDrive/AML2023/my-project-5-380117-07c0970b0d52.json'
# with open(file_path) as f:
#     data = json.load(f)

# Connecting to Google Acount
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "my-project-5-380117-07c0970b0d52.json"
...
with model_testing:  
    ...
    bucket = storage_client.bucket('laura-goodreads') # change the bucket name
...
with google_cloud:
    ...
    query = db.collection(u'Goodreads_Recommendations').order_by(u'created', direction=firestore.Query.DESCENDING)
...
#         blob = storage_client.bucket("laura-goodreads").blob(image_name)
